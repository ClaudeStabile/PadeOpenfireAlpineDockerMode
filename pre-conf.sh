...
wget -O openfire_4_7_4.tar.gz https://github.com/igniterealtime/Openfire/releases/download/v4.7.4/openfire_4_7_4.tar.gz
tar xvzf openfire_4_7_4.tar.gz -C /usr/share
rm openfire_4_7_4.tar.gz
