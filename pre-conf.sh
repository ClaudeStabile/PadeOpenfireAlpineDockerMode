...
java -version
wget -O openfire_5_0_1.tar.gz https://www.igniterealtime.org/downloadServlet?filename=openfire/openfire_5_0_1.tar.gz
tar xvzf openfire_5_0_1.tar.gz -C /usr/share
rm openfire_5_0_1.tar.gz
